...
func main() {
	fmt.Println("API - Learning in GO")
	r := mux.NewRouter()

	//seeding
	courses = append(courses, Course{CourseId: "2",
		CourseName: "ReactsJS", CoursePrice: 299,
		Author: &Author{Fullname: "GS", Website: "gs.dev"}})
	courses = append(courses, Course{CourseId: "3",
		CourseName: "NextJS", CoursePrice: 499,
		Author: &Author{Fullname: "Sodhi", Website: "sodhi.dev"}})
